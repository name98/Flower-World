...
public class CommentedFlowersFragment extends Fragment implements FragmentSetDataInterface {
    ...
    private void setTitle() {
        ...
        titleTextView.setText("Товары с Вашим отзывом");
    }
    ...
    private void setToolbar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Router.removeFragmentByTag(getContext(), Router.COMMENTED_PRODUCTS_TAG);
            }
        });
    }

    private void getData() {
        CommentedConnection connection = new CommentedConnection();
        connection.setParent(this);
        connection.bind(getUserId());
    }

    public static CommentedFlowersFragment newInstance() {

        return new CommentedFlowersFragment();
    }
}
